...
import { CustomisingIconsExample } from './examples/CustomisingIcons'
import customisingIconsSource from './examples/CustomisingIcons.tsx?raw'
import importAllIconsSource from './examples/ImportAllIcons.txt?raw'
import importSingleIconSource from './examples/ImportSingleIcon.txt?raw'
import overrideIconSizeSource from './examples/OverrideIconSize.txt?raw'
import renameImportedIconSource from './examples/RenameImportedIcon.txt?raw'
...
const ResourcesIcons: React.JSX.Element = () => {
  ...
  return (
    <>
      ...
      <DemoableDiv code={customisingIconsSource} codeHighlighter='shiki'>
        <CustomisingIconsExample />
      </DemoableDiv>
