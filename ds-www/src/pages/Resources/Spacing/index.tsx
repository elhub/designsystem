...
import marginsLayoutSource from './examples/MarginsLayout.txt?raw'
import navigationLayoutSource from './examples/NavigationLayout.txt?raw'
...
const ResourcesSpacing: React.JSX.Element = () => {
  return (
    <>
      ...
      <Row>
        <Column>
          <CodeDiv highlighter='shiki'>{navigationLayoutSource}</CodeDiv>
        </Column>
        <Column>
          <CodeDiv highlighter='shiki'>{marginsLayoutSource}</CodeDiv>
        </Column>
      </Row>
