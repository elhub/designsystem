...
import { CheckboxGroupDefaultExample } from './examples/Default'
import checkboxGroupDefaultSource from './examples/Default.tsx?raw'
import { CheckboxGroupControlledExample } from './examples/Controlled'
import checkboxGroupControlledSource from './examples/Controlled.tsx?raw'
import { CheckboxGroupSizesExample } from './examples/Sizes'
import checkboxGroupSizesSource from './examples/Sizes.tsx?raw'
import { CheckboxGroupDisabledExample } from './examples/Disabled'
import checkboxGroupDisabledSource from './examples/Disabled.tsx?raw'
import { CheckboxGroupErrorExample } from './examples/Error'
import checkboxGroupErrorSource from './examples/Error.tsx?raw'
...
const ComponentsCheckboxgroup: React.FC = () => {
  return (
    <>
      ...
      <DemoableDiv alignContent='center' code={checkboxGroupDefaultSource} codeHighlighter='shiki'>
        <CheckboxGroupDefaultExample />
      </DemoableDiv>
      ...
      <DemoableDiv alignContent='center' code={checkboxGroupControlledSource} codeHighlighter='shiki'>
      ...
      <DemoableDiv alignContent='center' code={checkboxGroupSizesSource} codeHighlighter='shiki'>
      ...
      <DemoableDiv alignContent='center' code={checkboxGroupDisabledSource} codeHighlighter='shiki'>
      ...
      <DemoableDiv alignContent='center' code={checkboxGroupErrorSource} codeHighlighter='shiki'>
