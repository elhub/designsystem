import { BodyText, Heading, VerticalSpace, Table } from '@elhub/ds-components'
import DemoableDiv from 'components/DemoableDiv/DemoableDiv'
import React from 'react'
import { DropdownDefaultExample } from './examples/Default'
import dropdownDefaultSource from './examples/Default.tsx?raw'
...
const ComponentsDropdown: React.FC = () => {
  return (
    <>
      ...
      <DemoableDiv alignContent='center' code={dropdownDefaultSource} codeHighlighter='shiki'>
