import { BodyText, Heading, Link, VerticalSpace } from '@elhub/ds-components'

import DemoableDiv from 'components/DemoableDiv/DemoableDiv'
import React from 'react'
import { ContainersContainerExample } from './examples/Container'
import containersContainerSource from './examples/Container.tsx?raw'
import { ContainersContentExample } from './examples/Content'
import containersContentSource from './examples/Content.tsx?raw'
import { ContainersHeaderExample } from './examples/Header'
import containersHeaderSource from './examples/Header.tsx?raw'
import { ContainersMarginExample } from './examples/Margin'
import containersMarginSource from './examples/Margin.tsx?raw'
import { ContainersNavExample } from './examples/Nav'
import containersNavSource from './examples/Nav.tsx?raw'

const ComponentsContainers: React.FC = () => {
  return (
    <>
      <VerticalSpace />
      ...
      <DemoableDiv alignContent='center' code={containersContainerSource} codeHighlighter='shiki'>
        <ContainersContainerExample />
      </DemoableDiv>
      ...
      <DemoableDiv alignContent='inherit' code={containersHeaderSource} codeHighlighter='shiki'>
        <ContainersHeaderExample />
      </DemoableDiv>
      ...
      <DemoableDiv alignContent='center' code={containersContentSource} codeHighlighter='shiki'>
        <ContainersContentExample />
      </DemoableDiv>
      ...
      <DemoableDiv code={containersMarginSource} codeHighlighter='shiki'>
        <ContainersMarginExample />
      </DemoableDiv>
    </>
  )
}
