...
import { DividerDefaultExample } from './examples/Default'
import dividerDefaultSource from './examples/Default.tsx?raw'
...
const ComponentsDivider = () => {
  return (
    <>
      ...
      <DemoableDiv alignContent='center' code={dividerDefaultSource} codeHighlighter='shiki'>
        <DividerDefaultExample />
      </DemoableDiv>
    </>
  )
}
