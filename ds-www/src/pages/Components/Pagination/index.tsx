...
import { PaginationDefaultExample } from './examples/Default'
import paginationDefaultSource from './examples/Default.tsx?raw'
...
const ComponentsPagination = () => {
  return (
    <>
      ...
      <VerticalSpace />
      <DemoableDiv alignContent='center' code={paginationDefaultSource} codeHighlighter='shiki'>
