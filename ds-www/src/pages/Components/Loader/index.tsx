...
import { LoaderDefaultExample } from './examples/Default'
import loaderDefaultSource from './examples/Default.tsx?raw'
import { LoaderSizesExample } from './examples/Sizes'
import loaderSizesSource from './examples/Sizes.tsx?raw'
import { LoaderVariantsExample } from './examples/Variants'
import loaderVariantsSource from './examples/Variants.tsx?raw'
...
const ComponentsLoader: React.FC = () => {
  return (
    <>
      ...
      <DemoableDiv alignContent='center' code={loaderDefaultSource} codeHighlighter='shiki'>
        <LoaderDefaultExample />
      </DemoableDiv>
      <VerticalSpace size='2' />
      ...
      <DemoableDiv alignContent='center' code={loaderSizesSource} codeHighlighter='shiki'>
        <LoaderSizesExample />
      </DemoableDiv>
      ...
      <DemoableDiv alignContent='center' code={loaderVariantsSource} codeHighlighter='shiki'>
