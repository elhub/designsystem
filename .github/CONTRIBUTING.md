...
Contributors is welcome to [open an issue on GitHub](/issues/).
...
the problem and understanding how to recreate it. Then submit the bug by [open an issue on GitHub](/issues/).

### Suggesting Enhancements

Before submitting an enhancement, consider whether the idea fits within the scope and aims of the project.
[Asking a question](#i-have-a-question) can be a good starting point. Then submit the enhancement as a suggestion by [open an issue on GitHub](/issues/).
